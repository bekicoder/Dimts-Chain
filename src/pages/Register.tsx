...
export default function Regiter() {
  return (
    ...
    <div className="w-full py-14 md:py-20 max-w-md gap-3 bg-white dark:bg-zinc-900 p-2 flex flex-col items-center md:shadow-2xl rounded-2xl border border-zinc-200 dark:border-zinc-800">
